...
function generateAntiPatternsSection(antipatterns) {
    const lines = [];
...
function generateStaticAnalysisSection(results) {
    const lines = [];
...
function generateTyposSection(typos) {
    const lines = [];
...
function formatAntiPatternName(name) {
    return name
        .split('-')
